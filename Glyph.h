...
struct Glyph {
	...
	static GlyphVec1 PossibleGlyphs(const Connection::Type up, const Connection::Type down, const Connection::Type left, const Connection::Type right, const int boolFlags);
...
const std::array<Glyph, Glyph::TOTAL> AllGlyphs{ // This is generated in Excel
{
	{ 0, 0, 0, 0, wxString::FromUTF8("\x20"), Connection::EMPTY, Connection::EMPTY, Connection::EMPTY, Connection::EMPTY },
	{ 1, 94, 1, 1, wxString::FromUTF8("\x21"), Connection::EMPTY, Connection::EMPTY, Connection::ORTHO_BOTH, Connection::ORTHO_BOTH },
	{ 2, 2, 2, 2, wxString::FromUTF8("\x22"), Connection::ORTHO_BOTH, Connection::ORTHO_BOTH, Connection::ORTHO_BOTH, Connection::ORTHO_BOTH },
...
GlyphVec1 Glyph::PossibleGlyphs(const Connection::Type up, const Connection::Type down, const Connection::Type left, const Connection::Type right, const int boolFlags) {
